...
public class StringUtil {
	...
	public static Date str2dat(String arg0, String arg1, String val)
			throws KettleException {
	...
	/**
	 * Giving back a date/time string in the format following the rule from the
	 ...
	 * @return a string in the form yyyddMM_hhmmssSSS (milliseconds will be
	 *         optional)
	 */
	...
	/**
	 * Giving back the actual time as a date/time string in the format following
	 * the rule from the most to the least significant
	 * 
	 * @return a string in the form yyyddMM_hhmmss
	 */
