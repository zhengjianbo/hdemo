		...
		select: {
			...
			setValue: function (n, t) {
			    ...
			    if (t.value == undefined || t.value == '') {
			        n.find(".ui-select").html("<div class=\"ui-select-text\" style=\"color:#999;\">未选择</div>");
			    }
			    else {
			        n.find(".ui-select").attr('data-value', t.value)
			        n.find(".ui-select").html("<div class=\"ui-select-text\" style=\"color:#999;\">" + t.value + "</div>");
			    }
			}
		},
		datetime: {
			...
			setValue: function (n, t) {
				...
				switch (t.infoType) {
					case "user":
						...
						break;
					case "department":
					    i.val(top.clientdepartmentData[t.value].FullName);
						i.attr("data-value", t.value);
						break;
					case "organize":
					    i.val(top.clientorganizeData[t.value].FullName);
						i.attr("data-value", t.value);
						break;
					case "date":
						i.val(t.value)
