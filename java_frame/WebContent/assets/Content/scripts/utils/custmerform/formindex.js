                ...
                function (t, i) {
                    ...
                    i.dataSource == "dataItem" ? u = {
                        ...
                        formatter: function (n) {
                            return top.clientdataItem[i.dataItemCode][n];//top.LD.data.get(["dataItem", i.dataItemCode, n]) 
                        }
                        ...
                        formatter: function (n) {
                            ...
                            switch (t.baseType) {
                                ...
                                case "department":
                                    ...
                                    break;
                                case "organize":
                                    t = top.clientorganizeData[n].FullName;//top.LD.data.get(["organize", n, "FullName"]);
                                    break;
                                case "post":
