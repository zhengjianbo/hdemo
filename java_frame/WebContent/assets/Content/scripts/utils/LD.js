...
function(n, t) {
    ...
    n.fn.comboBoxTree = function(i) {
        ...
        f = {
            ...
            loadData: function(i) {
                ...
                function(n, t) {
                    var r = top.LD.data.get(["dataItem", i.dataItemName, t[i.text]]);
                    r != "" && (t[i.text] = r);
                    i.data.push(t)
                })) : i.data = r
            },
    ...
    n.fn.authorizeButton = function() {
        ...
        r = top.LD.data.get(["authorizeButton", u]);
    ...
    n.fn.authorizeColModel = function() {
        ...
        t = top.LD.data.get(["authorizeColumn", u]);
...
formatDate = function(n, t) {
    return LD.formatDate(n, t)
};
toDecimal = function(n) {
    return LD.toDecimal(n)
};
request = function(n) {
    return LD.request(n)
};
changeUrlParam = function(n, t, i) {
    return LD.changeUrlParam(n, t, i)
};
$.currentIframe = function() {
    return LD.currentIframe()
};
$.isbrowsername = function() {
    return LD.isbrowsername()
};
...
$.isNullOrEmpty = function(n) {
    return LD.isNullOrEmpty(n)
};
IsNumber = function(n) {
    return LD.isNumber(n)
};
IsMoney = function(n) {
    return LD.isMoney(n)
};
$.arrayClone = function(n) {
    return LD.arrayCopy(n)
};
$.windowWidth = function() {
    return $(window).width()
};
...
checkedArray = function(n) {
    return LD.checkedArray(n)
};
checkedRow = function(n) {
    return LD.checkedRow(n)
};
$(function() {
