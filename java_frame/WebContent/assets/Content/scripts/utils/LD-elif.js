(function (n) {
    ...
    t = {
        init: function () {
		   ...
		   r={ templateInfo:{F_Name:"F_Name"},filedsInfo:[{F_RelationType:1,F_ColName:""}]  };
        ...
        loadData: function (r) {
            ...
            //console.log(r);
            try {
                LD.currentIframe().$("#gridTable").trigger("reloadGrid")
            } catch (h) { }
            for (s = r.Rows.length, i.success = [], i.fail = [], f = 0; f < s; f++) e = r.Rows[f],
            //e.rownum = f,
            e.LDColOk == "1" ? i.success.push(e) : i.fail.push(e);
            o = n("#girdPager");
