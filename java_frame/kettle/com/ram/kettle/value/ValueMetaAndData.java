...
public class ValueMetaAndData {
	...
	public ValueMetaAndData(String valueName, Object valueData)
		...
		if (valueData instanceof String) {
			this.valueMeta = new ValueMeta(valueName,
	...
	public Object clone() {
		...
		try {
			...
			vmad.valueData = null; // TODO: should we really do this? Is it
									// safe?
		}
	...
	public boolean loadXML(Node valnode) {
		...
		try {
			...
			int valtype = ValueMeta.getType(XMLHandler.getTagValue(valnode,
					"type"));
			...
			if (valtype != ValueMetaInterface.TYPE_STRING) {
				ValueMetaInterface originMeta = new ValueMeta(valname,
						ValueMetaInterface.TYPE_STRING);
