...
public interface ValueMetaInterface extends Cloneable {
	...
	public static final int TYPE_NSTRING = 9;
	...
	public static final String[] sortTypeCodes = new String[] { "none",
	 ...
	 *            true if the the date formatting (parsing) is to be set to
	 *            lenient
	 */
	...
	/**
	 * Write the content of this class (metadata) to the specified output
	 * stream.
	 * 
	 * @param outputStream
	 ...
	 *             In case there is a timeout (when set on a socket) during
	 *             reading
	 */
	...
	/**
	 * @return the storage Meta data that is needed for internal conversion from
	 *         BinaryString or String to the specified type. This storage Meta
	 *         data object survives cloning and should travel through the
	 *         transformation unchanged as long as the data type remains the
	 *         same.
	 */
	...
	/**
	 * This conversion metadata can be attached to a String object to see where
	 * it came from and with which mask it was generated, the encoding, the
	 * local languages used, padding, etc.
	 * 
	...
	/**
	 * Attach conversion metadata to a String object to see where it came from
	 * and with which mask it was generated, the encoding, the local languages
	 * used, padding, etc.
	 * 
	...
	/**
	 * @return true if the data type requires a real copy. Usually a binary or
	 *         Serializable object
	 */
