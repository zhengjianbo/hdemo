...
/**
 * This class handles basic encryption of passwords in Kettle. Note that it's
 * not really encryption, it's more obfuscation. Passwords are <b>difficult</b>
 * to read, not impossible.
 * 
 * @author Matt
 * @since 17-12-2003
 * 
