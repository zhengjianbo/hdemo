...
public interface DatabaseInterface extends Cloneable {
	...
	/**
	 * @return the plugin name of this database, the same thing as the
	...
	/**
	 * @param nrRows
	 *            The number of rows to which we want to limit the result of the
	 *            query.
	 ...
	 * @return the lowest possible technical key to be used as the NOT FOUND row
	...
	/**
	 * @return a list of table types to retrieve tables for the database This is
	 *         mostly just { "TABLE" }
	 */
	public String[] getTableTypes();

	/**
	 * @return a list of table types to retrieve views for the database This is
	 *         mostly just { "VIEW" }
	 */
	 ...
	 * @return The SQL command to unlock the database tables. null is returned
	 *         in case locking is not supported on the target database.
	 */
	public String getSQLUnlockTables(String tableNames[]);

	/**
	 * @return true if the database resultsets support getTimeStamp() to
	 ...
	 *         upper case. True for most databases except for stuborn stuff like
	 *         Postgres ;-)
	 */
	public boolean isDefaultingToUppercase();

	/**
	 * @return a map of all the extra URL options you want to set, retrieved
	 *         from the attributes list (NOT synchronized!)
	 */
	...
	/**
	 * @return The set of properties that allows you to set the connection
	 *         pooling parameters
	 */
	...
	/**
	 * @return true if the database supports sequences with a maximum value
	...
	public Object getValueFromResultSet(ResultSet resultSet,
			ValueMetaInterface valueMeta, int index) throws KettleException;

	/**
	 * @return true if the database supports the use of safe-points and if it is
	 *         appropriate to ever use it (default to false)
	 */
