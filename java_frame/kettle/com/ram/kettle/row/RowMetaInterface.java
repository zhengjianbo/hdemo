...
public interface RowMetaInterface extends Cloneable
{
     ...
     * @throws KettleException in case there was a problem converting the data.
     */
     ...
     * @throws KettleException in case there was a problem converting the data.
     */
    public BigDecimal getBigNumber(Object[] dataRow, int index) throws KettleException;
     ...
     * @throws KettleException in case there was a problem converting the data.
     */
    public Boolean getBoolean(Object[] dataRow, int index) throws KettleException;
     ...
     * @throws KettleException in case something is not quite right with the expected data
     */
    public Object[] cloneRow(Object[] objects, Object[] cloneTo) throws KettleException;
     ...
     * @throws KettleException in case there is a conversion error (only thrown in case of lazy conversion)
     */
    ...
    public String getString(Object[] dataRow, String valueName, String defaultValue) throws KettleException;
    public Long getInteger(Object[] dataRow, String valueName, Long defaultValue) throws KettleException;
    public Date getDate(Object[] dataRow, String valueName, Date defaultValue) throws KettleException;
     ...
     * @throws KettleException in case a I/O error occurs
     */
     ...
     * @throws KettleException in case a I/O error occurs
     */
    public void writeData(DataOutputStream outputStream, Object[] data) throws KettleException;
     ...
     */
    public Object[] readData(DataInputStream inputStream) throws KettleException, SocketTimeoutException;
     ...
     * @throws KettleException in case the value couldn't be found in the row metadata
     */
    public void removeValueMeta(String string) throws KettleException;
     ...
     * @throws KettleException in case of a conversion error
     */
     ...
     */
    public int compare(Object[] rowData1, Object[] rowData2, int fieldnrs[]) throws KettleException;
     ...
     * @throws KettleException
     */
    public boolean equals(Object[] rowData1, Object[] rowData2, int fieldnrs[]) throws KettleException;
     ...
     * @throws KettleException
     */
    public int compare(Object[] rowData1, Object[] rowData2, int fieldnrs1[], int fieldnrs2[]) throws KettleException;
     ...
     * @throws KettleException
     */
    public int compare(Object[] rowData1, RowMetaInterface rowMeta2, Object[] rowData2, int fieldnrs1[], int fieldnrs2[]) throws KettleException;
     ...
     * @throws KettleException
     */
    public int compare(Object[] rowData1, Object[] rowData2) throws KettleException;
     ...
     * @throws KettleException in case there is a data conversion error
     * @deprecated
     */
