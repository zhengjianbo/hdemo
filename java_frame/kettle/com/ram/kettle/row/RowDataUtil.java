...
public class RowDataUtil {
	...
	public static Object[] xresizeArray(Object[] objects, int newSize,
			int allocate_size) {
		Object[] newObjects;
	...
	public static Object[] resizeArray(Object[] objects, int newSize,
		...
		Object[] newObjects = new Object[newSize + allocate_size];
		if (objects != null)
			System.arraycopy(objects, 0, newObjects, 0, objects.length);
		return newObjects;
	}
	...
	public static Object  copyParamValue(Object objects) {
		if (objects.getClass().isArray()) {
			return copy((Object[]) objects);
		}
		return objects;
	}

	private static Object[] copy(Object[] objects) {
